...
class TestAccountLineDescription(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        consumable_cat = cls.env["product.category"].search([("name", "=", "Consumable")])
    ...
    def test_invoice_line_with_accounting_description(self):
        ...
        acc_desc_en = self.product_with_acc_desc.with_context(lang="en_US").accounting_description
    ...
    def test_invoice_line_without_accounting_description(self):
        ...
        consumable_cat = env_en["product.category"].search([("name", "=", "Consumable")])
