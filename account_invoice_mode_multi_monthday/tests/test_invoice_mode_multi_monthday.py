...
class TestInvoiceModeMultiMonthday(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.partner.invoicing_mode = "multi_monthday"
        cls.partner2 = cls.env.ref("base.res_partner_2")
        cls.partner2.invoicing_mode = "multi_monthday"
    ...
    def test_saleorder_with_different_mode_term(self):
        ...
        with tools.mute_logger("odoo.addons.queue_job.models.base"):
            ...
            ).generate_multi_monthday_invoices(self.company)
    ...
    def test_split_invoice_by_sale_order(self):
        ...
        self.partner.invoicing_mode = "multi_monthday"
