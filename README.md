...
[account_invoice_merge](account_invoice_merge/) | 16.0.1.0.0 |  | Merge invoices in draft
...
[partner_invoicing_mode](partner_invoicing_mode/) | 16.0.1.0.0 |  | Base module for handling multiple partner invoicing mode
[partner_invoicing_mode_at_shipping](partner_invoicing_mode_at_shipping/) | 16.0.1.0.0 |  | Create invoices automatically when goods are shipped.
[partner_invoicing_mode_monthly](partner_invoicing_mode_monthly/) | 16.0.1.0.0 |  | Create invoices automatically on a monthly basis.
