...
[sale_line_refund_to_invoice_qty](sale_line_refund_to_invoice_qty/) | 13.0.1.1.1 |  | Allow deciding whether refunded quantity should be considered as quantity to reinvoice
