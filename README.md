...
[account_invoice_blocking](account_invoice_blocking/) | 14.0.1.0.0 |  | Set a blocking (No Follow-up) flag on invoices
...
[account_invoice_payment_retention](account_invoice_payment_retention/) | 14.0.1.1.0 |  | Account Invoice Payment Retention
[account_invoice_pricelist](account_invoice_pricelist/) | 14.0.1.0.0 |  | Add partner pricelist on invoices
[account_invoice_refund_line_selection](account_invoice_refund_line_selection/) | 14.0.1.0.1 |  | This module allows the user to refund specific lines in a invoice
...
[account_invoice_section_sale_order](account_invoice_section_sale_order/) | 14.0.1.1.1 |  | For invoices targetting multiple sale order addsections with sale order name.
