...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-account_invoice_date_due>=16.0dev,<16.1dev',
        ...
        'odoo-addon-account_invoice_fixed_triple_discount>=16.0dev,<16.1dev',
        ...
        'odoo-addon-account_invoice_refund_reinvoice>=16.0dev,<16.1dev',
        ...
        'odoo-addon-account_move_line_packaging>=16.0dev,<16.1dev',
        'odoo-addon-account_move_line_purchase_packaging>=16.0dev,<16.1dev',
        'odoo-addon-account_move_original_partner>=16.0dev,<16.1dev',
        ...
        'odoo-addon-sale_invoice_date_from_picking>=16.0dev,<16.1dev',
        ...
        'odoo-addon-sale_stock_picking_invoicing>=16.0dev,<16.1dev',
        'odoo-addon-sale_timesheet_invoice_description>=16.0dev,<16.1dev',
        'odoo-addon-stock_account_move_reset_to_draft>=16.0dev,<16.1dev',
