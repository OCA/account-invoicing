...
class TestBudgetInvoice(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.budget_account_control_ids = [
                ...
                cls.env.user.company_id.account_sale_tax_id.mapped('invoice_repartition_line_ids.account_id').id,
        ]
        cls.budget_journal.account_control_ids = [(6, 0, cls.budget_account_control_ids)]
    ...
    def test_budget_validation(self):
        ...
        self.budget_journal.account_control_ids = [(6, 0, self.budget_account_control_ids)]
        self.b_invoice.action_post()
    ...
    def test_budget_consumption(self):
        ...
        self.assertEqual(self.b_invoice.budget_residual, self.b_invoice.amount_total + self.invoice.invoice_line_ids[1].price_total)
        self.assertEqual(self.b_invoice.budget_total_consumption, self.invoice.invoice_line_ids[1].price_total)
    ...
    def test_budget_consumption_account(self):
        self.b_invoice.action_post()
        self.invoice.invoice_line_ids[0].price_unit = 8000
        self.invoice.invoice_line_ids[1].account_id = self.product_b.property_account_income_id
        with self.assertRaises(UserError):
            self.invoice.action_post()
