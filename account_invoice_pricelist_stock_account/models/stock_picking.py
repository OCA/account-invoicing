...
class StockPicking(models.Model):
    ...
    def _get_invoice_vals(self, key, inv_type, journal_id, move):
        ...
        if not pricelist and picking.partner_id:
            # Set the default pricelist of the partner
            pricelist = picking.partner_id._get_pricelist_for_invoice(inv_type)

        inv_vals['pricelist_id'] = pricelist and pricelist.id
