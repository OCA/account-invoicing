...
class AccountInvoiceLine(models.Model):
    ...
    def _get_product_customer_code(self):
        ...
        for line in self.filtered(lambda il: il.invoice_id.partner_id.customer):
    ...
    product_customer_code = fields.Char(
        compute="_get_product_customer_code", string="Product Customer Code",
    )
    partner_is_customer = fields.Boolean(related="invoice_id.partner_id.customer",)
