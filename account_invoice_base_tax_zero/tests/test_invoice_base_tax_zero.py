...
class TestInvoiceBaseTaxZero(TransactionCase):
    ...
    def test_01_invoice_one_tax_zero(self):
        ...
        line1 = self.env['account.invoice.line'].create(line1_val)
        line2_val = {
            'invoice_id': invoice.id,
            'product_id': self.product.id,
            'account_id':
        ...
        line2 = self.env['account.invoice.line'].create(line2_val)
    ...
    def test_02_invoice_two_taxes_one_tax_zero(self):
        ...
        line3 = self.env['account.invoice.line'].create(line3_val)
        invoice.compute_taxes()
        invoice.action_invoice_open()
