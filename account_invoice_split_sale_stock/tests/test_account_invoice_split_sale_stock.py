...
class TestAccountInvoiceSplitSale(common.TransactionCase):
    ...
    def test_sale_order_prepaid_invoice_split(self):
        sale_order_01 = self.env.ref('sale.sale_order_7').copy()
        sale_order_01.order_policy = 'prepaid'
        ...
        self.assertEqual(sale_order_01.state, 'progress')
        ...
        self.assertEqual(len(sale_order_01.picking_ids.ids), 1)
        picking01 = sale_order_01.picking_ids[0]
        # Force Availability just for the test
        picking01.force_assign()
