...
class AccountInvoice(models.Model):
    ...
    def get_taxes_values(self):
        ...
        for line in self.invoice_line_ids.filtered("discount_fixed"):
            ...
            line.update({"price_unit": price_unit, "discount_fixed": 0.0})
...
class AccountInvoiceLine(models.Model):
    ...
    def _compute_price(self):
        ...
        self.update({"price_unit": price_unit, "discount_fixed": 0.0})
        super(AccountInvoiceLine, self)._compute_price()
        self.update(
            {"price_unit": prev_price_unit, "discount_fixed": prev_discount_fixed}
        )
