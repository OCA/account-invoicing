...
`feedback <https://github.com/OCA/account-invoicing/issues/new?body=module:%20account_invoice_fixed_discount%0Aversion:%2011.0-mig-account_invoice_fixed_discount%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OCA/account-invoicing <https://github.com/OCA/account-invoicing/tree/11.0-mig-account_invoice_fixed_discount/account_invoice_fixed_discount>`_ project on GitHub.
